...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 22, host: 28022, host_ip: "0.0.0.0", auto_correct: true
  config.vm.network "forwarded_port", guest: 8000, host: 28000, host_ip: "127.0.0.1", auto_correct: true
  config.vm.network "forwarded_port", guest: 80, host: 28080, host_ip: "0.0.0.0", auto_correct: true
  config.vm.network "forwarded_port", guest: 3389, host: 28389, host_ip: "0.0.0.0", auto_correct: true
  config.vm.network "forwarded_port", guest: 5901, host: 28901, host_ip: "127.0.0.1", auto_correct: true
